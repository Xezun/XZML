//
//  SelectFontNameViewController.m
//  Example
//
//  Created by 徐臻 on 2024/10/17.
//

#import "SelectFontNameViewController.h"
#import "SelectFontSizeViewController.h"

@interface SelectFontNameViewController () {
...
@implementation SelectFontNameViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([sender isKindOfClass:UITableViewCell.class]) {
        ...
        SelectFontSizeViewController *nextVC = segue.destinationViewController;
